...
DEPEND="dev-lang/python
	...
	sys-devel/gettext
	dev-util/pkgconfig"
# WARNING: BEFORE INCREASING THE libevhtp VERSION! Make sure, that after emerging with a higher number you can execute
# httpserver -f -c /var/lib/seafile/default/ccnet -d /var/lib/seafile/default/seafile-data -l /var/lib/seafile/default/logs/http.log -P /var/lib/seafile/default/pids/httpserver.pid
# without any error!
